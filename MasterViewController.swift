...
//  ContactList
//
//  Created by Francisco Escobar on 2021-12-14.
//
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate
{
    ...
    func gernerateTestData(alertController:UIAlertController)
    {
        ...
        (alertController.textFields![1]).text = "email"
        (alertController.textFields![2]).text = "phone"
        (alertController.textFields![3]).text = "street"
        (alertController.textFields![4]).text = "city"
        (alertController.textFields![5]).text = "province"
        (alertController.textFields![6]).text = "zip"
        (alertController.textFields![7]).text = "company"
    }
